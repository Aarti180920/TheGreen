...
const transport = nodemailer.createTransport(sendgridTransport({
    auth: {
        api_key: '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'
    }
}))
        ...
        .then(result => {
            ...
            transport.sendMail({
                ...
                html: `
                    ...
                    <p>Click this <a href='http://localhost:5557/reset/${token}'>link</a> to set a new password.</p>
                `
            })
        })
        .catch(err => {
